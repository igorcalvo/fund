...
def date_string(day: str | int, month: str | int, year: str | int, year_first: bool = True):
...
def get_previous_date(date, year_first: bool = True):
...
def sort_date_list(date_list: list, year_first: bool = True):
